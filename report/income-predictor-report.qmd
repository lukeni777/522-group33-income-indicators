...
While the Logistic Regression classifier was chosen to easier identify the socioeconomic features that are drivers of high income, we see an opportunity to use an ensemble model such as Random Forest Classification to improve the model's prediction metrics.
...
![Univariate Distribution of the Categorical Variables](../results/figures/categorical_distribution.png){#fig-categorical  height=75% fig-align="center"}
...
![Normalized Confusion Matrix Showing Model Performance on Unseen Test Data](../results/figures/income_indicator_confusion_matrix.png){#fig-confusion height=42%}
